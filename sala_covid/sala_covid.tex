...
\begin{frame}
	...
	\begin{tikzpicture}[overlay]
		\draw[mycolor5, very thick] (4.6,3.05) circle [x radius=4.0cm, y radius=.11cm, rotate=0];
	\end{tikzpicture}
	{\tiny Fuente: Juan Carbajal ($@$juank23\_7). Consultado el 29 de octubre del 2021. \\} 
	\vspace{0.01cm}
...
\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,4.53) circle [x radius=2.cm, y radius=.13cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 30 de octubre del 2021. \\}
\vspace{0.01cm}
$\nearrow$ Cusco sube al puesto 8, con $ 3,238 $ defunciones por COVID-19 por millón de habitantes. \\
	\end{frame}
...
Nota 2: Baja 4.1\%, 7 fallecidos menos. Resto del país sube 6.5\%, segunda semana al alza. \\
Mayor alza en el sur. \\
\textbf{Riesgos}: Sierra/selva sur crece dos semanas. Disparidad regional en alza. Piura nunca se acercó a cero, otros indicadores suben. \\
\textbf{Estancamiento}: Pocas alzas, todas leves. Catorce regiones estancadas ($\pm 1$).\\} 
\vspace{0.01cm}
$\rightarrow$ {\color{mycolor5}Cusco}: Las defunciones representan un $4.43\% $ del pico de la segunda ola, similar a la semana anterior. \\
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, ultra thick] (5.75,4.27) circle [x radius=3.4cm, y radius=.18cm, rotate=0];
		\end{tikzpicture}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-10-28.\\}
	\vspace{0.01cm}
	...
	$\nearrow$ Cusco sube a la posición 9 con un RT de $0.97$ $ [0.84-1.1]$.
	...
	\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 30 de octubre del 2021. \\
	Nota 1: Perú: 1027 camas libres, baja $1.2\%$. Lima: 298 camas libres, sube $ 1.7\% $. \\
	Suben $ >1\% $ {*} Tumbes (4.0\%), Piura (2.7\%), La Libertad (3.7\%), Ancash (4.4\%), Lima región (5.2\%), Lima metropolitana (1.1\%) e Ica (4.4\%) en la costa centro-norte, Apurímac (4.2\%), {\color{mycolor2}Cusco} (1.4\%), Madre de Dios (4.4\%) y Puno (1.8\%) en la sierra/selva sur más Huánuco (3.4\%) y Cajamarca (2.1\%) \\ Madre de Dios sube cuatro semanas, Tumbes, Piura y Lima región suben tres, La Libertad dos y Junín sube dos de las últimas tres semanas {\color{red}***}. Semanas previas: 9, 6, 5 y 5 regiones. \\ 
	Muy > que media: Piura (67\%), Ancash (60\%), Lima metropolitana (56\%) y {\color{mycolor2}Cusco} (59\%), todas subieron.\\}
	\vspace{0.01cm}
	$\nearrow$ Cusco aumenta el nivel de ocupación con respecto a la semana anterior.
\end{frame}
	...
	\end{center}
	\begin{tikzpicture}[overlay]
	\draw[mycolor2, thick] (5.1,2.11) circle [x radius=3.9cm, y radius=.15cm, rotate=0];
\end{tikzpicture}
	{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 30 de octubre del 2021.\\}
	\vspace{0.1cm}
	$\searrow$ Cusco pasa a la posición 22.
\end{frame}
	...
	\begin{frame}
		...
		\end{center}
		\begin{tikzpicture}[overlay]
		\draw[mycolor2, thick] (3.5,3.2) circle [x radius=2.0cm, y radius=.15cm, rotate=0];
		\end{tikzpicture}
		{\tiny Fuente: Lescano, Orellana, Fano, Pino, y Flores. Situación Epidemiológica de la COVID-19 al 30 de octubre del 2021. \\} 
		\vspace{0.01cm}
		$\nearrow$ Cusco se pasa al puesto 16.
...
\begin{frame}
	...
	\end{center}
	{\tiny Fuente: CDC MINSA. Reporte de Vigilancia COVID-19, Perú 2021. Actualización: 2021-10-28. Reporte de número reproductivo efectivo (Rt) de COVID-19. Disponible haciendo clic en el siguiente enlace: \href{https://www.dge.gob.pe/portalnuevo/informacion-publica/reporte-de-numero-reproductivo-efectivo-rt/}{CDC-Rt}. \\}
	\vspace{0.01cm}
...
\begin{frame}[label=cobertura_vacuna_provincias]
	...
	\hyperlink{vacunas_60}{\beamergotobutton{60 a 69 años}} \hyperlink{vacunas_50}{\beamergotobutton{50 a 59 años}} \hyperlink{vacunas_40}{\beamergotobutton{40 a 49 años}} \hyperlink{vacunas_30}{\beamergotobutton{30 a 39 años}}
	...
	\begin{frame}[label=camas]
		...
		\begin{table}[]
			\resizebox{8 cm}{!}{%
				\begin{tabular}{cccc}
					\hline
					\multicolumn{4}{c}{\textbf{UCIN,   SE 43}}                                                   \\ \hline
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL REGIONAL, SE 43}}                                 \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						6               & 5                    & 1                  & 86\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ANTONIO LORENA, SE 43}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						5                & 1                    & 4                  & 43\%                        \\ \hline
					\end{tabular}%
				}
		...
		\begin{center}
			...
			\begin{table}[]
				\resizebox{8 cm}{!}{%
					\begin{tabular}{cccc}
						\hline
						\multicolumn{4}{c}{\textbf{UCIN   HOSPITAL ADOLFO GUEVARA, SE 43}}                           \\ \hline
						TOTAL CAMAS UCIN & CAMAS   UCIN OCUPADAS & CAMAS   UCIN LIBRES & PORCENTAJE   OCUPACIÓN UCIN \\ \hline
						15               & 6                     & 8                   & 56\%                        \\ \hline
					\end{tabular}%
				}
...
\section{Indicadores por Provincias}
	\begin{frame}[label=semaforo]
		...
		\begin{table}[]
			\resizebox{\textwidth}{!}{%
				\input{../tablas/tabla_incidencia_provincia.tex}
			}
		\end{table}
	...
	\begin{frame}
		...
		\begin{table}[]
			\resizebox{\textwidth}{!}{%
				\input{../tablas/tabla_positividad_provincia.tex}
			}
		\end{table}	
		{\tiny Fuente de datos: SISCOVID, NOTICOVID.}
	...
	\begin{frame}
		...
		$\rightarrow$ Notablemente, las provincias de Acomayo, Calca, Espinar, Paucartambo han tenido \textbf{\color{mycolor5}una} defunción por COVID-19 en las últimas 9 semanas epidemológicas.
		
		$\rightarrow$ La última semana (SE43) sólo se registraron defunciones en Chumbivilcas Cusco, y Paruro.
